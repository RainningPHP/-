    ...
    >
      <el-form ref="form" :model="form" :rules="rules" label-width="140px">
        <el-row :gutter="20">
          ...
          <el-col :span="24">
            <el-form-item label="工期" prop="workTime">
              <el-input v-model="form.workTime" placeholder="请输入工期" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
          ...
          <el-col :span="24">
            <el-form-item label="配合单位及配合要求" prop="phrName">
              <el-input
                v-model="form.phrName"
                placeholder="请输入配合单位及配合要求"
              />
            </el-form-item>
          </el-col>
        </el-row>
...
export default {
  ...
  data() {
    return {
      ...
      upload: {
        ...
        // 上传的地址
        url: process.env.VUE_APP_BASE_API + "/system/styp/importData_new",
        // 上传的文件列表
        fileList: [],
  ...
  methods: {
    ...
    handleAdd() {
      ...
      this.dialogTitle = "新增四通一平";
      this.isAdd = true;
    },
    handleUpdate(row) {
      this.dialogVisible = true;
      this.dialogTitle = "修改四通一平";
      this.isAdd = false;
      this.form = row;
    },
