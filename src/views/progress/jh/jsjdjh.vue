    ...
    >
      <el-form ref="form" :model="form" :rules="rules" label-width="140px">
        <el-row :gutter="20">
          ...
          <el-col :span="24">
            <el-form-item label="节点名称" prop="planName">
              <el-input v-model="form.planName" placeholder="请输入节点名称" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
          ...
          <el-col :span="24">
            <el-form-item label="配合人" prop="phrName">
              <el-input v-model="form.phrName" placeholder="请输入配合人" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
      ...
      >
        ...
        <div class="el-upload__tip" slot="tip">
          ...
          <el-link
            ...
            @click="importTemplateBdz"
            >下载变电站模板</el-link
          >
          <br />
          <el-link type="info" style="font-size: 12px" @click="importTemplateXl"
            >下载线路模板</el-link
          >
        </div>
...
export default {
  ...
  data() {
    return {
      ...
      upload: {
        ...
        // 上传的地址
        url: process.env.VUE_APP_BASE_API + "/system/plan/importData_new",
        // 上传的文件列表
        fileList: [],
  ...
  methods: {
    ...
    handleAdd() {
      ...
      this.dialogTitle = "新增建设进度计划";
      this.isAdd = true;
    },
    handleUpdate(row) {
      this.dialogVisible = true;
      this.dialogTitle = "修改建设进度计划";
      this.isAdd = false;
      this.form = row;
    },
    ...
    importTemplateBdz() {
      downloadDefaultBdz().then((res) => {
        this.download(res.msg);
      });
    },
    importTemplateXl() {
      downloadDefaultXl().then((res) => {
        this.download(res.msg);
      });
    },
    submitFileForm() {
