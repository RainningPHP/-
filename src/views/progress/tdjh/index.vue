...
export default {
  ...
  methods: {
    getList() {
      ...
      getTdjhList(this.queryParams).then(res => {
    ...
    submitForm() {
      this.$refs.form.validate(value => {
        if (value) {
          addTdjhList(this.form).then(res => {
            this.handelCancel();
            this.getList();
    ...
    updateForm() {
      updateTdjhList(this.form).then(res => {
        this.handelCancel();
        this.getList();
        this.msgSuccess(res.msg);
      });
